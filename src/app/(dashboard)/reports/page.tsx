...
const hearingStatus = [
  { status: "Continued",        count: 20, color: "#3b82f6" }, // sky blue
  { status: "Dismissal",        count: 10, color: "#ec4899" }, // hot pink
  { status: "Favorable",        count: 50, color: "#22c55e" }, // green
  { status: "Good Cause Ltr",   count: 5,  color: "#14b8a6" }, // teal/cyan
  { status: "OTR at Hrg",       count: 2,  color: "#a3e635" }, // lime/yellow-green
  { status: "Pending Decision",  count: 8,  color: "#facc15" }, // dark charcoal
  { status: "Post HRG Review",  count: 3,  color: "#f97316" }, // orange
  { status: "Scheduled",        count: 15, color: "#7c3aed" }, // purple (large slice)
  { status: "Unfavorable",      count: 12, color: "#ef4444" }, // red
  { status: "WD Clmt Deceased", count: 1,  color: "#64748b" }, // slate gray
  { status: "Withdrawal",       count: 0,  color: "#9ca3af" }, // light gray
];
